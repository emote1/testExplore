...
export type TransferCommonFieldsFragment = { __typename?: 'Transfer', id: string, amount: any, timestamp: any, success: boolean, type: TransferType, signedData?: any | null, extrinsicHash?: string | null, from: { __typename?: 'Account', id: string }, to: { __typename?: 'Account', id: string }, token: { __typename?: 'VerifiedContract', id: string, name: string } } & { ' $fragmentName'?: 'TransferCommonFieldsFragment' };
