...
import { idlFactory } from './reef_metrics_assets.did.js';
export { idlFactory } from './reef_metrics_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REEF_METRICS_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reef_metrics_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reef_metrics_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reef_metrics_assets.did.js")._SERVICE>}
 */
export const reef_metrics_assets = createActor(canisterId);
